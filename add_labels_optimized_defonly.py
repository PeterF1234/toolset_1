...
def build_filedata(files,outfile,dumpfile,header,workdir='.'):
    ...
    molecule = ["NCE_1","NCE_2","NCE_3","NCE_4","PTZ_1","PTZ_2","PTZ_3",
                ...
                "Ph-Acr_1","Ph-Acr_2","Me2-Acr_1","Me2-Acr_2","Me2-Acr_3"]
    functionals = ["_B3LYP-D3","CAM-B3LYP-D3","M06_","M062X","M06L","PBE-D3","PBE0","wB97XD","TPSS","B97D3","TDHF"]
    basis = ["_def2TZVP","_TZVP","_def2SVP"]
    # Build the database
